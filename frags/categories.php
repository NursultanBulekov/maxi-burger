<?php
/* Connecting the categories page with local database*/
...
<?php for ($i=1; $i <= count($arr_all); ) { ?>
		<!-- Displaying the existing categories added by Admin -->
		<div class="row">
			<?php for ($j=1; $j <= 10; $j++) { ?>
				...
				<div class="card">
				    ...
				    <div class="card-content">
				      <span class="card-title activator grey-text text-darken-4">
						  <a class="black-text" href="foods.php?id=<?php echo $arr_all[$i+$j-2]['id']; ?>">
						  <?php echo $arr_all[$i+$j-2]['name']; ?></a><i class="material-icons right">more_vert</i></span>
				      <div class="card-content">
			          <p></p>
			        </div>
				    </div>
				    <div class="card-reveal">
				      <span class="card-title grey-text text-darken-4"><?php echo $arr_all[$i+$j-2]['name']; ?><i class="material-icons right">
						  close
						</i>
					</span>
