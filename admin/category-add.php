...
<div class="section white-text" style="background: #668c13;">
        ...
        <form action="../backends/admin/cat-add.php" method="post">
            ...
            <div class="row">
                ...
                <div class="col s6" style="">
                            ...
                            <label for="short_desc" style="color: white;"><b>Краткое описание :</b></label>
                            </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <label for="long_desc" style="color: white;"><b>Подробное описание :</b></label>
                </div>
            ...
            <div class="row">
                <div class="col s12">
                    <div class="section right" style="padding: 15px 10px;">
                        <a href="category-list.php" class="waves-effect waves-light btn">Отмена</a>
                    </div>
