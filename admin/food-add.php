    ...
    <div class="section center" style="padding: 40px;">
        ...
        <form action="../backends/admin/food-add.php" method="post">
            ...
            if (isset($_SESSION['msg'])) {
                echo '<div class="row" style="background: green; color: white;">
                <div class="col s12">
                    <h6>'.$_SESSION['msg'].'</h6>
                    </div>
                </div>';
            ...
            <div class="row">
                <div class="col s6" style="">
                            ...
                            <label for="name" style="color: white;"><b>Название :</b></label>
                            </div>
                </div>
                <div class="col s6" style="">
						    ...
						    <label style="color: white;">Меню</label>
						  </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <label for="desc" style="color: white;"><b>Описание :</b></label>
                </div>
            ...
            <div class="row">
                ...
                <div class="input-field">
                <input id="cost" name="cost" type="text" class="validate" style="color: white; width: 70%">
                <label for="cost" style="color: white;"><b>Цена :</b></label>
                </div>
            ...
            <div class="row">
                <div class="col s12">
                    <div class="section right" style="padding: 15px 10px;">
                        <a href="food-list.php" class="waves-effect waves-light btn">Отмена</a>
                    </div>
